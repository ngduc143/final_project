...
class PlacementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create placement" do
    assert_difference("Placement.count") do
      post placements_url, params: { placement: { Floor: @placement.Floor, Product_Shelves: @placement.Product_Shelves } }
    end
  ...
  test "should update placement" do
    patch placement_url(@placement), params: { placement: { Floor: @placement.Floor, Product_Shelves: @placement.Product_Shelves } }
