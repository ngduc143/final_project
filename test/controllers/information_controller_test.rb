...
class InformationControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create information" do
    assert_difference("Information.count") do
      post information_index_url, params: { information: { Brand: @information.Brand, Category: @information.Category, Date: @information.Date, Price: @information.Price } }
    end
  ...
  test "should update information" do
    patch information_url(@information), params: { information: { Brand: @information.Brand, Category: @information.Category, Date: @information.Date, Price: @information.Price } }
