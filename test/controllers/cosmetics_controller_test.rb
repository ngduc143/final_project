...
class CosmeticsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cosmetic" do
    assert_difference("Cosmetic.count") do
      post cosmetics_url, params: { cosmetic: { Price: @cosmetic.Price, Quantity: @cosmetic.Quantity } }
    end
  ...
  test "should update cosmetic" do
    patch cosmetic_url(@cosmetic), params: { cosmetic: { Price: @cosmetic.Price, Quantity: @cosmetic.Quantity } }
